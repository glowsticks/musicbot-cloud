...
```shell
docker pull quay.io/reddit-diabetes/musicbot-cloud:unsorted
docker run -d --name musicbot --restart always --env token='abc123' quay.io/reddit-diabetes/musicbot-cloud:unsorted
```
